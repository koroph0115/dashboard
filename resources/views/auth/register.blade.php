    ...
    <div class="row justify-content-center ">
        <div class="col-md-8">
            <div class="card border-0 shadow-sm">
                <div class="card-header register">{{ __('Inscription') }}</div>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label
                             text-md-right">{{ __('Addresse Email') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            col-form-label text-md-right">{{ __('Mot de passe')
                            }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            col-form-label text-md-right">{{ __('Confirmer
                            Mot de passe') }}</label>
